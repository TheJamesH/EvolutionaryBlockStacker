...
public class OnCollisionMakeSound : MonoBehaviour {
	...
	float[] pitches = new float[] { 0.84090378328F, 0.94387706945F, 1.05946F, 1.1224554916F, 1.25990633F, 1.4141887797F, 1.5873639619439F};
	...
	void OnCollisionEnter(Collision Col){
		if(asrc != null)
		{
			int pitchSelected = Random.Range(0, 7);
