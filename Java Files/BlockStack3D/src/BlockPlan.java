...
public class BlockPlan {
	...
	public void createRandomPlan(){
		...
		for(int i = 0; i < bNum; i++){
			...
			planData[i][2] = (int)( Math.random() * 99 ); //generates random int 0-99 for Z loc
		} 
	}
	...
	public void printPlan(){
		//prints out the plan
		for(int i = 0; i < bNum; i++){
			System.out.println(planData[i][0] + ", X=" + planData[i][1] + ", Z=" + planData[i][2]);
		}
	}
